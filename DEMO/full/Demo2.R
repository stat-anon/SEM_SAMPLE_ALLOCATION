...
df1 <- read.csv("rst201.csv") %>% mutate(scenario = "Equal reliability (r1)")
df2 <- read.csv("rst202.csv") %>% mutate(scenario = "Group 2 higher reliability (r2)")
df3 <- read.csv("rst203.csv") %>% mutate(scenario = "Both high reliability (r3)")
